...
int main()
{
    ...
    // Get and print the individual components of the default date by using the getters.
    ...
    // Set and print the individual components of the independence day by using the setters.
    ...
    // Get several dates from the stdin until EOF. Print each date in a proper format, and if the date is a valid, also print the date in the form dd-mmm-yyy.
...
/* Checks and prints a date. If the date is invalid, it prints an error message on stderr and returns the logical value false to the main() routine to flag 
   the error. */
